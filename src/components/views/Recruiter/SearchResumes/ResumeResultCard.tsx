...
const ResumeResultCard = ({ expand, setExpand, data, index, handleClick, isCheck, applicantEmailId, setApplicantEmailId, setIsCheck }: any) => {
  ...
  return (
    <>
      <div className="w-full self-stretch h-auto bg-white rounded-xl shadow flex-col justify-start items-start flex">
        <div className="w-full self-stretch h-auto p-7 flex-col justify-start items-start gap-7 flex">
            ...
            <div className="justify-start items-center gap-1 flex">
              <div className="w-6 h-6 relative">
                <input
                  ...
                  checked={isCheck.includes(Number(data.id))}
                />
              </div>
