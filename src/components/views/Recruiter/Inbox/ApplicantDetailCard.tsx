...
const ApplicantDetailCard = ({ expand, setExpand, data, index, shortListReject }: any) => {
  ...
  return (
    <>
      <div className="w-full h-auto bg-white rounded-xl shadow mt-7 flex-col justify-start items-start inline-flex">
        <div className="self-stretch h-auto p-7 flex-col justify-start items-start gap-7 flex">
          ...
          <div className="self-stretch h-auto flex-col justify-start items-start gap-5 flex">
            <div className="self-stretch justify-start items-start gap-3 inline-flex">
              <div className="grow shrink basis-0 text-black text-base font- leading-snug tracking-tight">Qualifications
              </div>
          ...
          <div className="self-stretch h-[0px] border border-indigo-100"></div>
          <Questionnaire profileDashboard={data} index={index} />
        </div>
