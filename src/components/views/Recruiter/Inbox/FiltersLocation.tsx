...
import { setLocation, setNavigateFilterOption, setLocationIds, setCheckItems } from '../../../../store/reducers/applicant/GetFilterApplicant';
import { Disclosure } from '@headlessui/react';
import { ChevronUpIcon } from '@heroicons/react/20/solid';
import { BiSearch } from 'react-icons/bi';

export const LocationApplicantBasedFilter = ({ handleLocationCheckbox, setIsOpen }: any) => {
  const dispatch = useAppDispatch();
  const { location, searchLocation } = useAppSelector((state) => state.getFilterApplicant);
...
const FiltersApplicantLocation = () => {
  const dispatch = useAppDispatch();
...
export default FiltersApplicantLocation;